...
export function TransferOwnershipDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" aria-describedby="transfer-ownership-dialog-description">
        <DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <p className="text-center py-4 text-sm text-gray-500">
                No other members found. You need to add members to the company before transferring ownership.
              </p>
            ) : (
