...
const featureHighlights = [
  ...
  },
  {
    ...
    description: "Λάβετε λεπτομερείς σημειώσεις με αναγνώριση ομιλητή από το Gemini 2.5 Pro. Εστιάστε στη συνομιλία, όχι στη λήψη σημειώσεων.",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Το ζωντανό κείμενο που βλέπετε κατά την εγγραφή είναι για άμεση ανατροφοδότηση UX. Η τελική, υψηλής ακρίβειας μεταγραφή υποβάλλεται σε επεξεργασία από το Gemini 2.5 Pro από τον αποθηκευμένο ήχο για μέγιστη ποιότητα και αξιοπιστία."
  },
  {
