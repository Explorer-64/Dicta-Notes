      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Dicta-Notes ਤੁਹਾਡੀਆਂ ਮੀਟਿੰਗਾਂ ਨੂੰ ਉੱਨਤ Google Gemini 2.5 ਏਆਈ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਰੀਅਲ-ਟਾਈਮ ਵਿੱਚ ਟ੍ਰਾਂਸਕ੍ਰਾਈਬ ਕਰਦਾ ਹੈ। ਸਵੈਚਾਲਤ ਤੌਰ 'ਤੇ 10+ ਵੱਖਰੇ ਸਪੀਕਰਾਂ ਦੀ ਪਛਾਣ ਕਰਦਾ ਹੈ ਅਤੇ 130+ ਭਾਸ਼ਾਵਾਂ ਵਿੱਚ ਅਨੁਵਾਦ ਕਰਦਾ ਹੈ.
          </p>
