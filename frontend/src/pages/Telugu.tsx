      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Dicta-Notes మీ సమావేశాలను అధునాతన Google Gemini 2.5 Pro AI ఉపయోగించి రియల్-టైమ్‌లో ట్రాన్స్‌క్రయిబ్ చేస్తుంది. స్వయంచాలకంగా 10+ వేర్వేరు స్పీకర్లను గుర్తిస్తుంది మరియు 130+ భాషలకు అనువదిస్తుంది.
          </p>
