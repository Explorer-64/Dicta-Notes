      ...
      const data = !responseFormat
        ...
        : await response[responseFormat]()
            .then((data) => {
              ...
              // Cache parsed data so .json()/.text() can be called again
              // without hitting "body stream already read" errors
              r.json = () => Promise.resolve(data);
              r.text = () => Promise.resolve(typeof data === 'string' ? data : JSON.stringify(data));
              return r;
            })
            .catch((e) => {
              r.error = e;
